...
function kmq_wp_new_user_notification_email($wp_new_user_notification_email, $user, $blogname) {
    ...
    $url_message = '<a href="https://tlp.digital/login-user" target="_blank" rel="noopener noreferrer">tlp.digital/login-user</a>';
